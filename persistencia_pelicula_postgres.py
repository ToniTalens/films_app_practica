...
class Persistencia_pelicula_postgres(IPersistencia_pelicula):
    ...
    """ Retrieves movies from the database with pagination, 
        starting from the specified id,and returns 
    ...
    """ Inserts a new movie into the database and 
    returns the inserted movie object."""
    ...
    """ Retrieves movies from the database for a given year
    ...
    """ Modifies an existing movie in the database 
        and returns the modified movie object. """
